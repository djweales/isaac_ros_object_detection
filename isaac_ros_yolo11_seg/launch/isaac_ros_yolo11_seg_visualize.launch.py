...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        #     name='yolo11_seg_visualizer_right',
        #     parameters=right_camera_parameters,
        #     remappings=[('right/image', 'right/image_rect')]
        # ),
        Node(
            package='isaac_ros_yolo11_seg',
            executable='isaac_ros_yolo11_seg_visualizer.py',
            name='yolo11_seg_visualizer_left',
            parameters=left_camera_parameters,
